...
def init():
    ...
    group.permissions.add(Permission.objects.get(codename="add_persona"))
    group.permissions.add(Permission.objects.get(codename="change_persona"))
    group.permissions.add(Permission.objects.get(codename="list_persona"))
    group.permissions.add(Permission.objects.get(codename="change_persona"))
    group.permissions.add(Permission.objects.get(codename="view_persona"))
    group.permissions.add(Permission.objects.get(codename="delete_persona"))
    group.save()
